 ...
 *Robin Pennock
 *homework5.c
 *to compile:  gcc -o homework5 homework5.c -lpthread
 *
*/ 

/*
	There is a binary semaphores to manage 10 threads that each add 10 to a local variable
	If the mutex functions correctly, the global variable should be 100 at end of program
*/
